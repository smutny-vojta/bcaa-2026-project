...
const createDefaultStop = (): StopFormValue => ({
  stop: "",
  plannedArrival: "",
  plannedDeparture: "",
});
...
export default function CreateRouteForm({
  ...
  const [type, setType] = useState<VehicleTypeType>("TRAIN");
  const [routeName, setRouteName] = useState("");
  const [carrier, setCarrier] = useState("");
  const [stops, setStops] = useState<StopFormValue[]>([createDefaultStop()]);
  ...
  const addStop = () => {
    setStops((prev) => [...prev, createDefaultStop()]);
  };
